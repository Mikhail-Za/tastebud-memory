...
const tools = [
  ...
  { name: 'memory_history', description: 'Complete immutable project event history within the configured trusted workspace, including payloads that candidate/detail views may withhold.', inputSchema: schema({ project: string }) },
